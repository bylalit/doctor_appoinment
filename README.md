🚀 Project Completed: Doctor Appointment Booking System 🩺
...
• Session Management & Authentication: Implemented using Django session handling

• Email Notification System: Sends booking confirmation via email

• Admin Panel: Created a fully functional admin dashboard to manage doctors, patients, and appointments
...
• Doctor profile and time-slot selection
...
• Separate admin dashboard for management
